        ...
        <section class="content" style="margin-top: 50px">
            ...
            <div class="card card-outline card-primary" dir="rtl">
                <div class="card-header">
                    <h3 class="card-title">الرد على المُرسِل : {{$messages->name}}</h3>
                </div>
                <!-- /.card-header -->
                <form class="form-horizontal" action="{{url('admin/messages/'.$messages->id.'/replay')}}" method="POST" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">الـرّد :</label>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">نـص الـرّد</label>
                            <div class="col-sm-10">
                            <textarea type="text" name="text_replay" class="form-control" rows="5">{{old('text_replay')}}</textarea>
                            </div>
                        </div>
