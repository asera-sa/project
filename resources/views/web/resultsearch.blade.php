          ...
          <div class="col-md-4 col-md-offset-4 mt-1" >
              <div class="card" style=" height:26rem;">
                   ...
                   <div class="card-body text-right">
                       ...
                       <p> <b>البريد الإلكتروني : </b>{{$item->email}} <br>
                         <b> رقم الهاتف : </b>{{$item->phone}} <br>
                         المدينة  : </b>{{$item->phone}}</p> 
     
                   </div>
                   <div class="card-footer text-muted text-right">
                       <a href="#" class="btn btn-primary btn-sm">عرض تفاصيل الصالة</a>
                       <a href="#" class="btn btn-success btn-sm">تواصل</a>
                   </div>
              </div>
