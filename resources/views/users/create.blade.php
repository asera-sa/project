...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">المستخدمين</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ مستخدم جديد </span>
						</div>
					</div>
            ...
            <form class="form-horizontal" action="{{url('/admin/User')}}" method="POST" >
            	...
            	<div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <input type="email" name="email" value="{{old('email')}}" class="form-control" autocomplete="on">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <input type="text" name="address" value="{{old('address')}}" class="form-control" autocomplete="on">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"> صلاحية </label>
                        <div class="col-sm-10">
                        <select name="prive" class="form-control">
                            <option value="1" >مسؤول</option>
                            <option value="2" >موظف حجز</option>
                        </select>
                        </div>
                    </div>
